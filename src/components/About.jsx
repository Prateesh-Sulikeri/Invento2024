...
const About = () => {
  return (
    <div className="container mx-auto py-12 flex flex-col md:flex-row items-center justify-center" id="about" style={{ paddingTop: '80px' }}>
      <div className="md:w-1/2">
        <h2 className="text-2xl font-semibold mb-4">Invento 2024</h2>
